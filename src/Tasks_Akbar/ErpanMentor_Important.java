...
public class ErpanMentor_Important {

    public static void main(String[] args) {

        // THIS IS ABOUT ArrayList:
        //it only Store the Object, NO primitive!!!!
        //ArrayList<int> list2 = new ArrayList<int>();---> this is wrong!
        //ArrayList<Integer> list2 = new ArrayList<Integer>();--> Right!
        //ArrayList<Double> list2 = new ArrayList<>();--> Right!
        ...
        Integer[] nums = new Integer[]{1, 2, 4, 5, 6, 6, 8, 90};
        ...
        Integer[] numsNewArray = numsList.toArray(new Integer[nums.length]);
