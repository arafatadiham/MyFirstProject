...
public class BikeAction {
    ...
    public static void main(String[] args) {
        ...
        // i dont want t get empty gear when object is created
        // i want to the bike coe with gear set to 1
        System.out.println("b1.gear = " + b1.gear);
        System.out.println("b2.gear = " + b2.gear);


        // I want to bw able to set the default gear to
        // any number I specify when the object is being created
        Bike b3 =  new Bike (4);
