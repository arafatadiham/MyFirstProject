package day27_Sunday;

public class Multi_DimensionalFindMax_IMPORTANT {
    public static void main(String[] args) {
        ...
        int maxLength = scrumTeam[0][0].length();//---> Assume the first one from development team has maximum;
