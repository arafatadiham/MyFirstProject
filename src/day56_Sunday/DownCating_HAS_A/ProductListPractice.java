...
//        System.out.println("Has Apple TV, with 299 or not result2 = " + result2); // false , no apple
        ...
        System.out.println("Has Sony TV after removing? = " + productList.contains(sony)); // contain method is from List, NOT String
        System.out.println("productList.indexOf(sony) after = " + productList.indexOf(sony));// contain method is from List, NOT String
